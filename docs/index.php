...
<div class="container" style="max-width: 1200px;">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The Digital Classroom” Website (web based application) is useful for the
	...
	<br>
	<p>Developed by @Kapratwar Akanksha</p>
	
	<p>Developed by @Lokhande Priya</p>
	
	<p>Developed by @Kadam Ashwini</p>

	<p>Developed by @Sawant Vaishnavi</p>
